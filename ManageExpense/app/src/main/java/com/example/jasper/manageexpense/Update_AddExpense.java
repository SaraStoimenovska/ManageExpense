                                ...
                                final AlertDialog.Builder dialogDelete = new AlertDialog.Builder(Update_AddExpense.this)
                                        ...
                                        .setPositiveButton("Yes", new DialogInterface.OnClickListener(){
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                Log.i("HELLOOOOO", "id: ");
                                                dbHelper.deleteAddExpense(listExpense.get(id).getId());
//                                                Log.i(listExpense.get(id).toString(), "id: ");
//                                                Log.i(listExpense.get(ids).toString(), "is: ");

//                                                dbHelper.deleteAddExpense(listExpense.get(ids).getId());
//                                                dbHelper.deleteAddCategory(name);
//                                                String strrr = dbHelper.getData(ids).toString();
//                                                Log.i(strrr, "onClick: ");
//                                                int idDelete = listExpense.get(id).getId();
//                                                dbHelper.deleteAddExpense(idDelete);
                                                adapter.notifyDataSetChanged();
                                                loadListView();
                                                Toast.makeText(Update_AddExpense.this, "Expense " + name + " with id " + ids + "is " + deleted, Toast.LENGTH_SHORT).show();
